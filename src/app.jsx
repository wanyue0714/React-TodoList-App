	...
	render() {
		...
		return <div className = "todo">
					<span>
						...
						<input type = "text" value = {this.state.text} className={(this.state.done)? 'done' : 'not-done'} onChange = {this.handleChange} onBlur = {this.handleSubmit} placeholder="Enter your Todo here"/>
					</span>
				</div>;
	}
}
